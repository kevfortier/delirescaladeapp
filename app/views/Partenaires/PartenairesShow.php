<html>
    <body>
        <div class="viewTitle col-md-12">
            <span>Mes demandes partenaires</span>
        </div>
        <?php echo Form::open(array('method'=>'get','action' => 'PartenairesController@show')); ?>
        <div id="filter-input">
            ...
            <div class="select-type-escalade col-xs-12 col-sm-3 col-md-2 col-lg-2" >
               <?php $back = isset($_GET['typeStatus'])?$back=$_GET['typeStatus']:null;
                 ...
                 DemandeStatus::Answered  => 'Avec réponse',DemandeStatus::Closed  => 'Demande Pairée'),
                 $back,array('class'=> 'form-control frm-bloc placeholder-color')); ?></br>   
            </div>
         ...
         <div class="user-list">
            ...
            { ?>
                <div class="user-list-item col-xs-12 col-sm-6 col-md-4  col-lg-3" >
                    ...
                    <div>
                        <img style="height:60px;width:51.64px;display:inline-block;" src="<?php if($partenaire->hasAcceptedAnOffer){echo asset('img/partenaire/climbRed.png');} else if($partenaire->hasRecivedAnOffer){echo asset('img/partenaire/climbYellow.png');}else{echo asset('img/partenaire/climbGreen.png');}?>">
                    </div> 
                    <div style="margin-left:14px;vertical-align:top;">
                        <?php
                            ...
                            switch ($partenaire->typeEscalade) {// e est la meme chose que htmlspecialchars
                                case UserType::Grimpeur: echo e('<P. Cordée>');break;
                                case UserType::Traceur: echo e('<Moulinette>');break;
                                case UserType::Admin : echo e('<Bloc>');break;
        ...
        <?php if(count($data)<1){ ?>
            <div class="viewTitle col-md-12" style="border:none;">
                <span style="font-size:23px;">Vous n'avez aucune demande de partenaire.</span>
            </div>
        <?php } ?>
    </body>
</html>